...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/admin/expense/update/<?= $expense['id'] ?>" method="POST">
                    <div class="row">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4" 
                                  placeholder="Enter expense description..." required><?= old('description', $expense['description']) ?></textarea>
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-6">
                        ...
                        <div class="fw-medium"><?= date('M d, Y', strtotime($expense['created_at'])) ?></div>
                    </div>
                    <div class="col-6">
                        <small class="text-muted">Updated:</small>
                        <div class="fw-medium"><?= date('M d, Y', strtotime($expense['updated_at'])) ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="/admin/expense/create" class="btn btn-outline-success btn-sm">
